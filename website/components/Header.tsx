          ...
          {MVP_CATEGORIES.map(cat => {
            ...
            return (
              <Link
                key={cat}
                href={`/${slug}`}
                className="flex-shrink-0 text-xs sm:text-sm font-medium px-3 sm:px-4 py-2 min-h-[36px] flex items-center rounded-t transition-colors text-gray-500 dark:text-gray-400"
